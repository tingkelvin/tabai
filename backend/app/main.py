...
from app.api import auth, youtube, llm
...
app.include_router(youtube.router, tags=["YouTube Processing"])
...
async def read_root():
    ...
    return {"message": "Welcome to the YouTube Video Processor API! Use /process-youtube-video endpoint."}