        ...
        {/* Welcome Message */}
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-slate-700">Official Website</p>
                <p className="text-xs text-slate-500">tab.com</p>
              </div>
            </a>

            <a 
              href="mailto:support@tab.com" 
              className="flex items-center gap-2 p-3 bg-white/50 hover:bg-white rounded-lg border border-slate-200 transition-colors group"
            >
              <div className="w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center group-hover:bg-slate-200 transition-colors">
                <svg className="w-4 h-4 text-slate-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            >
              <div className="w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center group-hover:bg-slate-200 transition-colors">
                <svg className="w-4 h-4 text-slate-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path d="M7 11v2.4h3.97l-4.21 4.6h2.42l4.21-4.6v-2.4h-6.39zm6.39 0h-2.42l-4.21 4.6v2.4h6.39v-2.4h-3.97l4.21-4.6z"/>
                </svg>
              </div>
              <div className="flex-1">
